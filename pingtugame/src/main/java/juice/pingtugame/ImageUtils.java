...
public class ImageUtils {
    ...
    public static Bitmap ImageUtil(Bitmap bmp, float huge, float saturation, float lum) {
        ...
        //实例化处理色相的颜色矩阵
        ColorMatrix hugeMatrix = new ColorMatrix();    /************设置色相、饱和度、亮度***************/
        ...
        imageMatrix.postConcat(hugeMatrix);      /************合成颜色矩阵***************/
    ...
    public static Bitmap ImgaeToNegative(Bitmap bitmap) {
        ...
        //下面用循环来处理每一个像素点
        for (int i = 0; i < width * height; i++) {   /************一个像素点就是一个颜色***************/
            ...
            color = Color.argb(a, r, g, b);    /************通过颜色分量拿到Color***************/
            newPx[i] = color;
        }
