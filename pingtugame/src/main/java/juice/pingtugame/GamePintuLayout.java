...
//        mBitmap = ImageUtils.ImageUtil(mBitmap, 127, 127, 125);   //图像处理：色光三原色：色相、饱和度、亮度
//        mBitmap =ImageUtils.ImgaeToNegative(mBitmap);
//        mBitmap =ImageUtils.ImgaeToOld(mBitmap);
        mBitmap =ImageUtils.ImgaeToRelief(mBitmap);
