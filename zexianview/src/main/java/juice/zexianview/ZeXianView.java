...
public class ZeXianView extends View
{
    ...
    public ZeXianView(Context context)
    {
        super(context);
    ...
    public ZeXianView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    public ZeXianView(Context context, AttributeSet attrs, int defStyleAttr)
    {
...
//        a.recycle();
    ...
    private void drawText(Canvas canvas)
    {
        ...
        textPaint.setColor(textNormalColor);
//        textPaint.setXfermode(textNormalColor);
    ...
    {
        dottedPaint.setPathEffect(new DashPathEffect(new float[]{20, 10}, 4));  //设置样式，6种
